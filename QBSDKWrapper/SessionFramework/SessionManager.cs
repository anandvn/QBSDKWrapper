...
namespace SessionFramework
{
    ...
    public class SessionManager : IDisposable
    {
        ...
        public static SessionManager getInstance(string AppId, string AppName)
        {
            if (sessionMgr == null)
            {
                sessionMgr = new SessionManager();
                sessionMgr.initialize(AppName, AppId, defaultConnectionType);
            }
            return sessionMgr;
        }
        ...
        private bool doRequests(bool logError, ref IMsgSetRequest requestSet)
        {
            try
            {
                ...
                //Console.WriteLine(_queryResponse.ToXMLString());
        ...
        private void getBackendSdkVersion()
        {
            ...
            {
                string svers = supportedVersions[i];
